...
public class Matrix {
     ...
     * @param matrix Matrix
     */
    private void throwExceptionForNotIdenticalMatrix(Matrix matrix) {
    ...
    public void sum(Matrix matrix) {
        throwExceptionForNotIdenticalMatrix(matrix);
        for (int i = 0; i < this.rows.length; i++) {
    ...
    public static Matrix getSum(Matrix matrix1, Matrix matrix2) {
        matrix1.throwExceptionForNotIdenticalMatrix(matrix2);
